  ...
  Widget _emptyOrders() {
    return Center(
      child: Container(
          child: Text(
        'NO RECORDS FOUND!',
        style: TextStyle(fontSize: 20, letterSpacing: 1, color: Color(red)),
      )),
    );
  }
                        ...
                        Expanded(
                          child: ButtonTheme(
                            ...
                            child: RaisedButton(
                              ...
                              color: isEnabled5 ? Color(red) : Color(yellow),
                              onPressed: () async {
                                setState(() {
                                  isEnabled5 = true;
                                  isEnabled6 = false;
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color:
                                      isEnabled5 ? Color(yellow) : Color(red),
                                  fontSize: 13.0,
                        ...
                        Expanded(
                          child: ButtonTheme(
                            ...
                            child: RaisedButton(
                              ...
                              color: isEnabled6 ? Color(red) : Color(yellow),
                              onPressed: () async {
                                setState(() {
                                  isEnabled6 = true;
                                  isEnabled5 = false;
                              ...
                              child: Text(
                                "Asc",
                                style: TextStyle(
                                  color: isEnabled6 ? Colors.white : Color(red),
                                  fontSize: 13.0,
                                  fontWeight: FontWeight.w400,
                                ),
                              ),
                            ...
                            child: RaisedButton(
                              ...
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.only(
                                      topLeft: Radius.circular(25),
                                      bottomLeft: Radius.circular(25))),
                              color: isEnabled7 ? Color(red) : Color(yellow),
                              onPressed: () async {
                                setState(() {
                                  isEnabled7 = true;
                                  isEnabled8 = false;
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color:
                                      isEnabled7 ? Color(yellow) : Color(red),
                                  fontSize: 13.0,
                                  fontWeight: FontWeight.w400,
                                ),
                              ),
                            ...
                            child: RaisedButton(
                              ...
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.only(
                                      topRight: Radius.circular(25),
                                      bottomRight: Radius.circular(25))),
                              color: isEnabled8 ? Color(red) : Color(yellow),
                              onPressed: () async {
                                setState(() {
                                  isEnabled8 = true;
                                  isEnabled7 = false;
                              ...
                              child: Text(
                                "Asc",
                                style: TextStyle(
                                  color: isEnabled8 ? Colors.white : Color(red),
                                  fontSize: 13.0,
                                  fontWeight: FontWeight.w400,
                                ),
                              ),
                            ...
                            child: RaisedButton(
                              ...
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.only(
                                      topLeft: Radius.circular(25),
                                      bottomLeft: Radius.circular(25))),
                              color: isEnabled9 ? Color(red) : Color(yellow),
                              onPressed: () async {
                                setState(() {
                                  isEnabled9 = true;
                                  isEnabled10 = false;
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color:
                                      isEnabled9 ? Color(yellow) : Color(red),
                                  fontSize: 13.0,
                                  fontWeight: FontWeight.w400,
                                ),
                              ),
                            ...
                            child: RaisedButton(
                              ...
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.only(
                                      topRight: Radius.circular(25),
                                      bottomRight: Radius.circular(25))),
                              color: isEnabled10 ? Color(red) : Color(yellow),
                              onPressed: () async {
                                setState(() {
                                  isEnabled10 = true;
                                  isEnabled9 = false;
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color:
                                      isEnabled10 ? Colors.white : Color(red),
                                  fontSize: 13.0,
                                  fontWeight: FontWeight.w400,
                                ),
                              ),
                        ...
                        child: RaisedButton(
                          ...
                          shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.only(
                                  topLeft: Radius.circular(25),
                                  bottomLeft: Radius.circular(25))),
                          color: isEnabled3 ? Color(red) : Colors.white,
                          onPressed: () async {
                            setState(() {
                              isEnabled3 = true;
                              isEnabled4 = false;
                          ...
                          child: Row(children: [
                            Image(
                              ...
                              height: 17.0,
                              width: 17.0,
                              color: isEnabled3 ? Colors.white : Color(red),
                            ),
                            SizedBox(
                              width: 5.0,
                            ),
                        ...
                        child: RaisedButton(
                          ...
                          shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.only(
                                  topRight: Radius.circular(25),
                                  bottomRight: Radius.circular(25))),
                          color: isEnabled4 ? Color(red) : Colors.white,
                          onPressed: () async {
                            setState(() {
                              isEnabled4 = true;
                              isEnabled3 = false;
                          ...
                          child: Row(children: [
                            Text(
                              "Filter",
                              style: TextStyle(
                                color: isEnabled4 ? Colors.white : Color(red),
                                fontSize: 13.0,
                                fontWeight: FontWeight.w400,
                              ),
                            ),

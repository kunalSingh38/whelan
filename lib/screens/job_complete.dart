...
class _ChangePageState extends State<JobCollection> {
  ...
  TextEditingController driverNameCont = TextEditingController();
  Widget quizList() {
    return Column(children: <Widget>[
      Container(
        margin: const EdgeInsets.only(right: 15.0, left: 15),
        child: TextFormField(
            controller: driverNameCont,
            keyboardType: TextInputType.text,
            cursorColor: Color(0xff000000),
            textCapitalization: TextCapitalization.sentences,
            onSaved: (String value) {
              driverNameCont.text = value;
            },
            validator: (value) {
              if (value.isEmpty) {
        ...
        InkWell(
          ...
          child: Align(
              ...
              child: Container(
                ...
                child: Text("Clear", style: TextStyle(color: Color(red))),
              )),
        )
      ]),
      SizedBox(
      ...
      Container(
        ...
        child: TextFormField(
            ...
            validator: (value) {
              if (value.isEmpty) {
                return 'Please enter consignment note email';
              }
              return null;
            },
            decoration: InputDecoration(
                ...
                counterText: "",
                hintText: 'Consignment Note Email',
                hintStyle: TextStyle(color: Color(0xffcdcbcb), fontSize: 16),
                fillColor: Color(0xffffffff),
                filled: true)),
      ),
                              ...
                              onChanged: (String newValue) {
                                showDialog(
                                    ...
                                    builder: (context) => AlertDialog(
                                          ...
                                          content: Text(
                                              "Are you sure you want to tip at selected depot?"),
                                          actions: [
                                            TextButton(
                                                onPressed: () {
                                                  Navigator.of(context).pop();
                      ...
                      if (_type == "") {
                        ...
                        if (sign.points.length != 0 &&
                          ...
                          uploadRequest.fields['collection_qty'] =
                              collection_qty;
                          uploadRequest.fields['collection_vat'] = "0.0";
                          uploadRequest.fields['collection_amount'] = "0.0";
                          ...
                          uploadRequest.fields['driver_name'] =
                              driverNameCont.text.toString();
                        ...
                        if (response.statusCode == 200) {
                          if (data_data['status'] == 200) {
                            ...
                            if (sign.points.length != 0 &&
                              ...
                              uploadRequest.fields['collection_signatory'] =
                                  signatoryController.text;
                              uploadRequest.fields['payment_mode'] = "paid";
                              uploadRequest.fields['payment_status'] = "cash";

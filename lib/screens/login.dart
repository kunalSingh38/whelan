...
class _SplashScreenState extends State<LoginScreen> {
  ...
  void getData() async {
    ...
    setState(() {
      ...
      splashImageURL = jsonDecode(data)['data']['splash_screen'].toString();
      client_logo = jsonDecode(data)['data']['client_logo'].toString();
      splash_screen = jsonDecode(data)['data']['splash_screen'].toString();
      red = int.parse(pref.getString("red_color"));
      yellow = int.parse(pref.getString("yellow_color"));
    });
  }
                    ...
                    if (_formKey.currentState.validate()) {
                      ...
                      if (response.statusCode == 201) {
                        ...
                        if (errorCode == 201) {
                          ...
                          // };
                          // var uri =
                          //     Uri.parse(URL + 'checklist/is-checklist-display')
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: NetworkImage(splashImageURL),
                            fit: BoxFit.fitWidth),
                      ),
                    ),
                    SizedBox(
                    ...
                    Center(
                      child: BorderedText(
                        ...
                        child: Text(appName.toString(), style: normalText),
                      ),
                    ),
                    _loginContent(),
                  ],
